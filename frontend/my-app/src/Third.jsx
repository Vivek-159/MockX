            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 relative overflow-hidden">
              ...
              <div className="mb-8">
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-sm font-medium text-indigo-600">86%</span>
                </div>
              ...
              <div className="mb-8">
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-sm font-medium text-indigo-600">76%</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2.5">
              ...
              <div className="mb-8">
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-sm font-medium text-indigo-600">91%</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2.5">
                  <div className="bg-indigo-600 h-2.5 rounded-full" style={{width: '91%'}}></div>
                </div>
              </div>
              ...
              <div className="absolute -right-4 top-20 z-10">
                <div className="bg-purple-200 h-10 w-10 rounded-full border-2 border-white"></div>
              </div>
